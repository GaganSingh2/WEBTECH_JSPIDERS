...
function Cart() {
    ...
    const [products, setItem] = useState(items)
    // const{image, title,unit, time, price, category} = item
    const handlIncrement = () => {
        setItem({ ...products, unit: products.unit < 10 ? products.unit + 1 : products.unit })
    }

    const handlDecrement = () => {
        setItem({ ...products, unit: products.unit === 0 ? 0 : products.unit - 1 })
    }
    return (
